  ...
  return (
    <div className="relative">
      <div
        className={clsx(
          props.isShowSidebar &&
            "w-screen h-screen backdrop-blur-md absolute md:w-0 md:h-0"
        )}
      ...
      <aside
        id="logo-sidebar"
        className={clsx(
          "fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200 md:translate-x-0 dark:bg-main2 dark:border-gray-700",
